...
const HomePage = () => {
    ...
    const { data: newArrivalsData, isLoading: isNewLoading, error: newError } = useGetProductsQuery({ limit: 4 });
    const { data: topSellingData, isLoading: isTopLoading, error: topError } = useGetProductsQuery({ limit: 4, skip: 4 });
    return (
        <>
            <AppHero />
            <AppBrandsBar/>
